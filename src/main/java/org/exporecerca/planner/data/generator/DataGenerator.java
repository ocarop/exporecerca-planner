package org.exporecerca.planner.data.generator;
...
import org.exporecerca.planner.data.Role;
import org.exporecerca.planner.data.entity.SamplePerson;
import org.exporecerca.planner.data.entity.User;
import org.exporecerca.planner.data.service.SamplePersonRepository;
import org.exporecerca.planner.data.service.UserRepository;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 7, 28, 0, 0, 0));
